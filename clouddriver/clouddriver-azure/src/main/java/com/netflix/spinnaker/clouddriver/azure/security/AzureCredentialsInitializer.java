...
/** Azure credentials initializer with dynamic loading support. */
@Configuration
public class AzureCredentialsInitializer {
  ...
  public CredentialsRepository<AzureNamedAccountCredentials> azureCredentialsRepository(
    ...
    return new MapBackedCredentialsRepository<>("azure", eventHandler);
  }
  ...
  public AbstractCredentialsLoader<AzureNamedAccountCredentials> azureCredentialsLoader(
    ...
    if (azureCredentialsSource == null) {
      azureCredentialsSource = azureConfigurationProperties::getAccounts;
    }
    return new BasicCredentialsLoader<>(azureCredentialsSource, azureCredentialsParser, repository);
  }
